    ...
    <PageSection variant="default"
        ...
        <PageSectionContent>
            ...
            <ArticleInfoBlock image="images/logo/agency-logo.png"
                              :paragraphs="[
                                  `<b>Ryan Balieiro</b> created <em>Foxy</em>, a free Vue3 & Bootstrap 5.0 theme. The downloadable files consist of the entire source code, including HTML, CSS, and Javascript. Please feel free to download and customize the theme as you wish.`,
